...
(function() {
    ...
    class Animation {
      constructor(worldState, robot, robotState) {
        ...
        robotPic.src = "https://eloquentjavascript.net/img/robot_moving2x.gif"
        this.parcels = []
      ...
      updateParcels() {
        ...
        for (let {place, address} of this.worldState.parcels) {
          ...
          node.style.cssText = "position: absolute; height: 16px; width: 16px; background-image: url(https://eloquentjavascript.net/img/parcel2x.png); background-position: 0 -" + offset + "px";
      ...
      clicked() {
        if (this.timeout == null) {
          this.schedule()
          this.button.textContent = "Stop"
          this.robotElt.firstChild.src = "https://eloquentjavascript.net/img/robot_moving2x.gif"
        } else {
